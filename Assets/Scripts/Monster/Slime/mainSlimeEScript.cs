...
public class mainSlimeEScript : Monsters, MonsterCommonFeatures1
{
    enum state
    {
        idle = 0,
    ...
    private void Awake()
    {
        ...
        iOWiz = gameObject.transform.GetChild(1).GetComponent<IOWiz>();
    }
    ...
    public void ChangeState()
    {
        ...
        iOWiz.Set_monsterState(monsterState);
    }
    public void IOWizOne()
    {
        //공격!
        Debug.Log("Attack!1");
    }
